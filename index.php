...
<head>
    ...
    <title>Home - LiBlio Integrated Library System- A Digital and Automated Method of Keeping Library Collections</title>
            ...
            <nav class="navbar">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <!--Logo-->
                        <a href="#sc1" class="navbar-left show"><img src="images/logo.png" width="120" alt="library"></a>
                        <div class="space-10"></div>
                    </div>
                    <!--Toggle-button-->
            ...
            <div class="container">
                <div class="row wow fadeInUp">
                    <div class="col-xs-12 col-sm-10 col-sm-offset-1 text-center">
                        <div class="jumbotron">
                            <h1 class="text-white">LiBlio Integrated Library System</h1>
                            <p class="text-white">A Digital and Automated Method of Keeping Library Collections
                        </div>
                                        ...
                                        <form action="books.php">
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-btn">
                                                    <button type="submit" class="btn" id="more"><i class="icofont icofont-search-alt-2"></i></button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 text-center">
                    ...
                    <p>The most popular book categories to start your education</p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 text-center">
                    <a href="books.php" class="btn" id="more">See More</a>
                </div>
            </div>
            <div class="space-80"></div>
        </div>
