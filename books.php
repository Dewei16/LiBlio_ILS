...
<head>
    ...
    <title>Books - LiBlio_ILS - A Digital and Automated Method of Keeping Library Collections</title>
            ...
            <div class="container">
                <div class="row wow fadeInUp">
                    <div class="col-xs-12 col-sm-10 col-sm-offset-1 text-center">
                        <div class="jumbotron">
                            <h1 class="text-white">Choose Your Preferred Book and Borrow It</h1>
                        </div>
                ...
                <div class="col-xs-12 col-md-2">
                    <aside>
                        ...
                        <div class="sigle-sidebar">
                            ...
                            <a href="#" class="btn btn-xs" id="more"> See All</a>
                        </div>
                        <div class="space-20"></div>
                    </aside>
                </div>
