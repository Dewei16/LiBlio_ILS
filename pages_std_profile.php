            ...
            <div id="page_content_inner">
                <div class="uk-grid" data-uk-grid-margin data-uk-grid-match id="user_profile">
                    <div class="uk-width-large-7-10">
                        <div class="md-card">
                            <div class="user_heading user_heading_bg" style="background-image: url('assets/img/gallery/Image1.jpg')">
                                <div class="bg_overlay">
                                    ...
                                    <div class="user_heading_content">
                                        <h2 class="heading_b uk-margin-bottom"><span class="uk-text-truncate"><?php echo $row->s_name;?></span><span class="sub-heading">Student @LiBlio.info</span></h2>
                                                ...
                                                <ul class="md-list md-list-addon">
                                                    <li>
                                                        ...
                                                        <div class="md-list-content">
                                                            ...
                                                            <span class="uk-text-small uk-text-muted">LiBlio Number</span>
                                                        </div>
                                                    </li>
