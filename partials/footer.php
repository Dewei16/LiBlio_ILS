    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-4">
                <a href="#"><img src="images/logo.png" width="120" alt="library"></a>
                <div class="space-20"></div>
                <p>LiBlio Integrated Library System- A Digital and Automated Method of Keeping Library Collections</p>
                <div class="space-10"></div>
                <ul class="list-inline list-unstyled social-list">
                    <li><a href="https://www.facebook.com/LiBlio.Info" target="_blank"><i class="icofont icofont-social-facebook"></i></a></li>
            ...
            <div class="col-xs-12 col-sm-4 col-md-3 col-md-offset-1">
                ...
                <table class="table border-none addr-dt">
                    ...
                    <tr>
                        ...
                        <td><a href="https://www.facebook.com/LiBlio.Info" target="_blank">LiBlio.Info</a></td>
                    </tr>
                </table>
            </div>
            <div class="col-xs-12 col-sm-4 col-md-3 col-md-offset-1">
